...
| Rápido/barato | `gpt-5-mini`, `gemini-3.5-flash` |
...
<AccordionGroup>
  ...
  <Accordion title="Use modelos mais baratos para iteração">
    Use `gpt-5-mini` ou `gemini-3.5-flash` durante a iteração e depois troque os fluxos de trabalho mais pesados por modelos mais robustos apenas onde for necessário.
  </Accordion>
