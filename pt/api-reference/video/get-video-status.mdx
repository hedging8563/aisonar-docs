...
Se a tarefa não existir mais ou não puder mais ser resolvida através dos detalhes do modelo async-task, AI Sonar retorna `async_task_not_found` com a mensagem `Task not found or no longer available.`
</Info>
