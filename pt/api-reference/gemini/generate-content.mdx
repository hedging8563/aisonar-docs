...
<ParamField path="model" type="string" required>
  ...
  A AI Sonar usa o caminho Gemini nativo quando disponível e alterna para um caminho público compatível quando o tratamento nativo não está disponível para essa requisição multimodal.
...
<ParamField body="contents" type="array" required>
  ...
  Para partes de mídia, a AI Sonar aceita atualmente MIME types de imagem, áudio e vídeo e os encaminha pelo detalhes do modelo compatível com Gemini.
