...
Nota de compatibilidade: se `input_fidelity` for enviado com `gpt-image-2`, a AI Sonar o remove porque o GPT Image 2 já processa entradas de imagem em alta fidelidade.
</Note>
...
<ParamField body="response_format" type="string" default="url">
  ...
  Para solicitações `gpt-image-2` Azure Official ou compatíveis com Azure, a AI Sonar recebe os dados de imagem como `b64_json`. Para solicitações `url`, a AI Sonar envia cada imagem ao CDN e retorna `data[].url`. Se o armazenamento CDN estiver indisponível ou o upload falhar, a solicitação falha em vez de ser convertida em uma resposta Base64. Para `b64_json`, o Base64 bruto é retornado.
</ParamField>
