...
Se a tarefa não existir mais ou não puder mais ser resolvida por meio dos detalhes do modelo de async-task, o AI Sonar retorna `async_task_not_found` com a mensagem `Task not found or no longer available.`
</Info>
