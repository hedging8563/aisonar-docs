...
Esses endpoints de gestão cobrem mídias pertencentes ao AI Sonar e Worlds gerados concluídos. AI Sonar ainda não expõe geração `marble-1.0-draft` nem ferramentas pano/depth independentes.
