...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle` (object): estágio do ciclo de vida, datas de lançamento/depreciação, modelo substituto e origem do badge latest
  - `aisonar.commercial` (object): política de cobrança do usuário, motivo gratuito e prazo opcional de gratuidade
  - `aisonar.badges` (array): badges derivados dos metadados de ciclo de vida e comercial
</ResponseField>
