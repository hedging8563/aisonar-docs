...
<ResponseField name="purpose" type="string">Tipo de evento ou mensagem retornado pela API.</ResponseField>
<ResponseField name="bytes" type="integer">String decimal em USD para reconciliação de cobrança.</ResponseField>
