...
| `logicalModel` | string | comprimento máximo `100` | Nome do modelo solicitado |
...
- `logicalModel` se refere ao modelo público solicitado por quem faz a chamada.
...
- `accessChannel=platform` significa que a solicitação foi cobrada pelo canal de plataforma da AI Sonar.
