...
Use os IDs de modelo mostrados pela AI Sonar em `model` e escolha variantes com `operation` e os inputs de midia correspondentes. Exemplos: `wan-2.7`, `happyhorse-1.0`, `viduq3`, `viduq3-mix`, `pixverse-v6`, `kling-3.0-video`, `veo3.1` e `seedance-2.0`; nao use nomes de operacao do provedor como nomes de modelo da AI Sonar.
...
- Para `grok-imagine-video`, vídeo-para-vídeo usa um `video_url` público `.mp4`; limites específicos do modelo, como `duration` e `resolution`, devem vir do detalhe do modelo.
