...
description: "Entenda o modelo de preços de pagamento conforme o uso (pay-as-you-go) da AI Sonar"
---

## Visão Geral

A AI Sonar utiliza o **modelo de preços pay-as-you-go**. Você paga apenas pelo que usar, sem assinaturas ou compromissos mínimos.
...
Preços ao vivo podem mudar conforme provedores, rotas e contratos de modelo. Use o Dashboard, a página de modelos, `GET /v1/models/:model/pricing` e a [Pricing API](/api-reference/pricing/get-pricing) como fonte da verdade.
...
1. Envie a tarefa. A AI Sonar pode aplicar uma pré-dedução ou reserva estimada para verificar saldo e limites de gasto da API Key.
...
Se o dashboard não refletir a liquidação ou o reembolso depois que o estado terminal estiver visível, entre em contato com .
...
Monitore seu uso no [Painel](https://console.aisonar.dev):
...
1. Faça login no [Painel](https://console.aisonar.dev)
...
Entre em contato com  para consultas de faturamento.
