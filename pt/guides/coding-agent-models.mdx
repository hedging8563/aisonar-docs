...
## Seleção de Provedor no AI Sonar

O AI Sonar seleciona automaticamente um provedor disponível para o modelo solicitado.
...
Se um provedor estiver indisponível ou retornar um erro, o AI Sonar tenta automaticamente com outro provedor disponível:
...
Quando o modelo selecionado oferece suporte a um formato de API nativo, o AI Sonar pode usar esse formato para obter melhor compatibilidade:
