...
A Agent-First API da AI Sonar enriquece respostas de erro com dicas estruturadas que agentes de IA podem analisar e agir imediatamente — sem buscas na web, sem consultas à documentação, sem suposições.
...
<Note>
Endpoints compatíveis com OpenAI usam os tipos de erro públicos estáveis da AI Sonar, como `rate_limit_exceeded`, `upstream_error` e `all_channels_failed`. Endpoints compatíveis com Anthropic e Gemini usam suas próprias formas de resposta nativas.
</Note>
