...
O cache de prompt no nível do provedor é automático pelo AI Sonar. Prompts de sistema longos — que agentes de código sempre incluem — são armazenados em cache no nível do provedor:
...
| AI Sonar (roteamento inteligente) | ~$10–18 | ~$1.600–2.900 |
| AI Sonar + cache de prompt | ~$4–8 | ~$640–1.280 |
| AI Sonar + ambos os caches | ~$2–5 | ~$320–800 |
...
Cada ferramenta precisa de apenas algumas linhas para se conectar pelo AI Sonar:
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Configurações → Modelos → Chave da API da OpenAI: `sk-your-key`, URL base: `https://api.aisonar.dev/v1`
