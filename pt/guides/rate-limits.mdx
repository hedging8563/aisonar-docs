...
<Note>
  Os limites de taxa estão sujeitos a alterações. Entre em contato com  para limites personalizados.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Entre em contato conosco para limites mais altos">
    Se você precisar de limites mais altos, entre em contato com .
  </Accordion>
</AccordionGroup>
