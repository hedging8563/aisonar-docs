...
A AI Sonar implementa limites de taxa para garantir uso justo e estabilidade da plataforma. Os limites variam de acordo com o nível da conta.
...
<Note>
  Os limites de taxa estão sujeitos a alterações. Entre em contato com support@aisonar.dev para limites personalizados.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Entre em contato conosco para limites mais altos">
    Se você precisar de limites mais altos, entre em contato com support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Faça login no seu [Dashboard](https://console.aisonar.dev)
2. Vá para **Settings → Account**
3. Entre em contato com o suporte com seu caso de uso

Ou envie um email para support@aisonar.dev com:
