...
Rotas públicas não distinguem no corpo da resposta estados como erro de digitação, modelo oculto, diferido ou não público. Se um modelo não estiver atualmente disponível através do contrato público, a AI Sonar retorna `model_not_found`.
