...
3D üretimi asenkron bir süreçtir. `POST /v1/3d/generations` bir AI Sonar görevi oluşturur; tamamlanmış durum yanıtları, `model_url` gibi indirilebilir model varlıkları döndürür ve mevcut olduğunda format-spesifik URL'leri içerir.
