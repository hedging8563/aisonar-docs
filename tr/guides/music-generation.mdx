...
Mevcut kamu örnekleri müzik üretimi için `suno_music` kullanmaktadır. Sadece söz akışları için, söz üretimini belgeleyen bir model ile `action: "LYRICS"` gönderin. Model kimliklerini kamu AI Sonar kimlikleri olarak değerlendirin, sağlayıcıya özgü alanların kamu sözleşme alanları olduğu garantisi olarak değil.
