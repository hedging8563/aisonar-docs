...
AI Sonar, adil kullanım ve platform kararlılığını sağlamak için rate limitleri uygular. Limitler hesap katmanına göre değişir.
...
<Note>
  Rate limitleri değişikliğe tabidir. Özel limitler için support@aisonar.dev ile iletişime geçin.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Daha yüksek limitler için bizimle iletişime geçin">
    Daha yüksek limitlere ihtiyacınız varsa support@aisonar.dev ile iletişime geçin.
  </Accordion>
</AccordionGroup>
...
1. [Dashboard](https://console.aisonar.dev) hesabınıza giriş yapın
2. **Settings → Account** bölümüne gidin
3. Kullanım senaryonuzla birlikte support ekibiyle iletişime geçin

Veya support@aisonar.dev adresine şu bilgilerle e-posta gönderin:
