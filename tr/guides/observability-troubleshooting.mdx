...
İyi bir AI Sonar gözlemlenebilirliği, kamuya açık tanımlayıcılarla başlar. Loglarınız, "kullanıcı ne talep etti, AI Sonar hangi kamuya açık görevi oluşturdu ve nasıl faturalandırıldı?" sorularını yanıtlamanıza yardımcı olmalı; hassas sağlayıcı detaylarını veya hassas kullanıcı verilerini ifşa etmeden.
...
API anahtarları, yönetim tokenları, özel medya, tam istemler, sağlayıcı URL'leri, kanal ID'leri veya özel tanılama tanımlayıcılarını dahil etmeyin, AI Sonar desteği açıkça redakte edilmiş bir örnek istemedikçe.
