...
description: "Asenkron medya işleri oluşturun, genel AI Sonar görev durumunu sorgulayın ve sağlayıcıya özgü kimlikler olmadan nihai sonuçları uzlaştırın."
---

Birçok medya uç noktası asenkron olarak çalışır. Bir oluşturma isteği, çalışmayı başlatır ve genel bir AI Sonar görev kimliği döndürür; uygulamanız, o görev terminal bir duruma ulaşana kadar sorgulama yapar. Müşteri iş akışlarını yukarı akış görev URL'leri, yönlendirme kimlikleri veya sağlayıcı geri çağırma davranışları etrafında inşa etmeyin.
...
|------|--------|--------------|
| `id` | Genel AI Sonar görev kimliği | Kendi iş kaydınızla saklayın |
