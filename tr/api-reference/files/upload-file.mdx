...
<ResponseField name="purpose" type="string">API tarafından dönen event veya message type.</ResponseField>
<ResponseField name="bytes" type="integer">Billing mutabakatı için USD decimal string.</ResponseField>
