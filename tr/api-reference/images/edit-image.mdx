...
Uyumluluk notu: Bir `gpt-image-2` isteği `input_fidelity` gönderirse AI Sonar bu alanı kaldırır; çünkü GPT Image 2 görüntü girdilerini zaten otomatik olarak yüksek doğrulukta işler.
</Note>
...
<ParamField body="response_format" type="string" default="url">
  ...
  Azure Official veya Azure-compatible `gpt-image-2` isteklerinde AI Sonar görüntü verisini `b64_json` olarak alır. `url` isteklerinde AI Sonar her görseli CDN’e yükler ve `data[].url` döndürür. CDN depolama kullanılamıyorsa veya upload başarısız olursa istek Base64 yanıtına çevrilmeden başarısız olur. `b64_json` için ham Base64 döndürülür.
</ParamField>
