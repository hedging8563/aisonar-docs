...
Bu yönetim endpointleri AI Sonar sahipliğindeki medya varlıklarını ve tamamlanan world kayıtlarını kapsar. AI Sonar hâlâ `marble-1.0-draft` üretimini veya bağımsız pano/depth araçlarını açmaz.
