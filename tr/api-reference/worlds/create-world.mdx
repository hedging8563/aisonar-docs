...
This endpoint covers world generation and polling. AI Sonar does not currently proxy World Labs media asset upload, world listing, world deletion, or standalone pano tools.
