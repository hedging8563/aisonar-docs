...
<ParamField body="top_n" type="integer">
  Döndürülecek en iyi sonuç sayısı. Varsayılan olarak tüm documents döner. En az `1` olmalı ve `documents.length` değerini aşmamalıdır. Bir provider ileride daha sıkı bir public limit yayımlarsa AI Sonar bunu burada dokümante eder ve uygular.
</ParamField>
