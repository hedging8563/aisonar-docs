...
<ParamField body="material_asset_id" type="string">
  [Materyal oluştur](/tr/api-reference/video/create-material-asset) tarafından döndürülen AI Sonar Seedance materyal ID'si. Materyal `ACTIVE` olduktan sonra Seedance 2.0 üretim modelleriyle kullanın.
</ParamField>

<ParamField body="material_asset_ids" type="array">
  Birden fazla AI Sonar Seedance materyal ID'si. `reference_images` ile aynı Seedance görsel referans sınırını paylaşır; Seedance 2.0 için toplamda en fazla 9 görsel referans gönderin.
</ParamField>
