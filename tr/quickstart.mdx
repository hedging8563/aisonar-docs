...
description: "AI Sonar API ile 2 dakikada başlayın"
---
...
<Steps>
  <Step title="Hesap oluşturun">
    E-posta, Gmail veya GitHub hesabınızla [aisonar.dev](https://aisonar.dev) üzerinden kaydolun.
  </Step>
...
AI Sonar yüzlerce modeli destekler. Yalnızca `model` alanını değiştirin:
