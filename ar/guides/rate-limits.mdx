...
تُطبّق AI Sonar حدود المعدل لضمان الاستخدام العادل واستقرار المنصة. تختلف الحدود حسب فئة الحساب.
...
<Note>
  حدود المعدل عرضة للتغيير. تواصل مع support@aisonar.dev للحصول على حدود مخصصة.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="تواصل معنا للحصول على حدود أعلى">
    إذا كنت بحاجة إلى حدود أعلى، تواصل مع support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. سجّل الدخول إلى [Dashboard](https://console.aisonar.dev)
2. انتقل إلى **Settings → Account**
3. تواصل مع الدعم موضحًا حالة الاستخدام الخاصة بك

أو أرسل بريدًا إلكترونيًا إلى support@aisonar.dev يتضمن:
