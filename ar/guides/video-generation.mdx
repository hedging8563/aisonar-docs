...
يقبل عقد الفيديو العام في AI Sonar قيم العمليات التالية. يختلف الدعم حسب النموذج ويتغير عندما يضيف المزودون قدرات أو يوقفونها، لذلك اقرأ عقد النموذج المحدد قبل الاعتماد على عملية متخصصة.
...
استخدم `aisonar.capabilities` و `aisonar.supported_operations` و `aisonar.public_contract_summary` و `aisonar.public_contract` كمصدر الحقيقة. الأمثلة أدناه أنماط سير عمل وليست جردًا كاملًا للنماذج.
