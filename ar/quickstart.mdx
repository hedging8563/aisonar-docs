---
title: "البدء السريع"
description: "ابدأ مع AI Sonar API في دقيقتين"
---
...
<Steps>
  <Step title="إنشاء حساب">
    سجّل في [aisonar.dev](https://aisonar.dev) باستخدام بريدك الإلكتروني أو Gmail أو حساب GitHub.
  </Step>
...
تدعم AI Sonar مئات النماذج. غيّر حقل `model` فقط:
