...
<ParamField body="model" type="string" default="veo3.1">
  معرّف نموذج الفيديو. القيمة الافتراضية في API هي `veo3.1`. راجع [دليل إنشاء الفيديو](/ar/guides/video-generation) و [واجهة Models API](/ar/api-reference/models/list-models) لمعرفة قدرات نماذج الفيديو العامة الحالية.
</ParamField>
