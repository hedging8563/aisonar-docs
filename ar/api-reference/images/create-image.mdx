...
<ParamField body="response_format" type="string" default="url">
  ...
  بالنسبة إلى طلبات `gpt-image-2` على Azure Official أو الخدمات المتوافقة مع Azure، تحصل AI Sonar على بيانات الصور بصيغة `b64_json`. عند طلب `url` ترفع AI Sonar كل صورة إلى CDN وتعيد `data[].url`. إذا لم يكن تخزين CDN متاحًا أو فشل الرفع، يفشل الطلب بدلاً من تحويله إلى استجابة Base64. عند طلب `b64_json` يُعاد Base64 الخام.
</ParamField>
