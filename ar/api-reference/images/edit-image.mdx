...
ملاحظة توافق: إذا أرسل طلب `gpt-image-2` الحقل `input_fidelity`، تزيله AI Sonar لأن GPT Image 2 يعالج مدخلات الصور تلقائيا بدقة عالية.
</Note>
