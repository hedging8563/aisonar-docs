...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle`(object): 수명 주기 단계, 출시/지원 중단 날짜, 대체 모델, latest 배지 기준
  - `aisonar.commercial`(object): 사용자 과금 정책, 무료 사유, 선택적 무료 종료 시각
  - `aisonar.badges`(array): 수명 주기와 상업 메타데이터에서 파생된 표시 배지
</ResponseField>
