...
프로바이더 레벨 Prompt Cache는 AI Sonar를 통해 자동으로 작동합니다:
...
| AI Sonar (스마트 라우팅) | ~$10~18 | ~$1,600~2,900 |
| AI Sonar + Prompt Cache | ~$4~8 | ~$640~1,280 |
| AI Sonar + 양쪽 캐시 | ~$2~5 | ~$320~800 |
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    설정 → 모델 → OpenAI API 키: `sk-your-key`, Base URL: `https://api.aisonar.dev/v1`
