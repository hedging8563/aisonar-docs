---
title: "결제 및 요금"
description: "AI Sonar의 종량제 요금 체계를 이해합니다"
---

## 개요

AI Sonar는 **종량제 요금제(pay-as-you-go)**를 사용합니다. 구독이나 최소 약정 없이 사용한 만큼만 비용을 지불하면 됩니다.
...
1. 작업을 제출합니다. AI Sonar는 잔액과 API Key 사용 한도를 확인하기 위해 예상 금액을 선차감하거나 예약할 수 있습니다.
...
터미널 상태가 확인된 뒤에도 dashboard에 정산 또는 환불이 반영되지 않으면 로 문의하세요.
...
[대시보드](https://console.aisonar.dev)에서 사용량을 모니터링하세요:
...
1. [대시보드](https://console.aisonar.dev)에 로그인
2. **크레딧 추가** 클릭
3. 금액 및 결제 수단 선택
4. 결제 완료
