...
현재 공개 예제는 음악 생성을 위해 `suno_music`을 사용합니다. 가사 전용 흐름의 경우, 가사 생성을 문서화한 모델과 함께 `action: "LYRICS"`를 전송하십시오. 모델 ID는 공개 AI Sonar ID로 취급하며, 제공자 특정 필드가 공개 계약 필드라는 보장은 아닙니다.
