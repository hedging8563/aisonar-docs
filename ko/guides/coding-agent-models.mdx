...
새로운 코딩 지향 모델 풀에서는 매우 큰 저장소에 `qwen-long-latest`, 대용량 컨텍스트 에이전트 작업에 `minimax-m3`, 빠른 코딩 루프에 `kimi-k2.7-code-highspeed`, OpenAI Chat 호환 라우팅에 `deepseek-v4-pro` / `deepseek-v4-flash`, `glm-5.2`, `step-3.7-flash`, `mimo-v2.5-pro`도 고려하세요.
