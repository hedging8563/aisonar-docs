...
AI Sonar는 공정한 사용과 플랫폼 안정성을 보장하기 위해 rate limit을 적용합니다. 제한은 계정 tier에 따라 달라집니다.
...
<Note>
  Rate limit은 변경될 수 있습니다. 사용자 지정 제한이 필요하면 support@aisonar.dev로 문의하세요.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="더 높은 제한이 필요하면 문의하세요">
    더 높은 제한이 필요하면 support@aisonar.dev로 문의하세요.
  </Accordion>
</AccordionGroup>
...
1. [Dashboard](https://console.aisonar.dev)에 로그인합니다
2. **Settings → 계정**로 이동합니다
3. 사용 사례와 함께 support에 문의합니다

또는 다음 내용을 포함하여 support@aisonar.dev로 이메일을 보내세요:
- 계정 이메일
- 예상 요청량
- 사용 사례 설명
