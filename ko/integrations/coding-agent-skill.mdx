...
description: "관리 중인 AI Sonar API 통합 스킬을 설치하고 coding agent가 모델을 찾고 모델 세부정보을 읽으며 API 오류에서 복구하도록 안내합니다."
---
...
| 비채팅 계약 불일치 | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_shape_mode`, `recommended_request` | 모델 세부정보에서 요청을 다시 만들고 의도를 바꾸는 필드는 return a clear error 처리합니다 |
