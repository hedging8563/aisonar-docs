...
| `logicalModel` | string | max length `100` | Requested model name |
...
- `logicalModel` refers to the model requested by the caller.
...
- `accessChannel=platform` means the request was billed via AI Sonar’s platform channel.
