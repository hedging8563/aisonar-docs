...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle` (object): Lifecycle stage, release/deprecation dates, replacement model, and latest badge derivation
  - `aisonar.commercial` (object): User charge policy, free reason, and optional free-until timestamp
  - `aisonar.badges` (array): Display badges derived from lifecycle and commercial metadata
</ResponseField>
