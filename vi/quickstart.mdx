---
title: "Bắt đầu nhanh"
description: "Bắt đầu với AI Sonar API trong 2 phút"
---
...
<Steps>
  <Step title="Tạo tài khoản">
    Đăng ký tại [aisonar.dev](https://aisonar.dev) bằng email, Gmail hoặc tài khoản GitHub của bạn.
  </Step>
...
AI Sonar hỗ trợ hàng trăm mô hình. Chỉ thay đổi trường `model`:
