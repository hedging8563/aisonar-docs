...
<ParamField body="response_format" type="string" default="url">
  ...
  Với `gpt-image-2` qua Azure Official hoặc dịch vụ tương thích Azure, AI Sonar nhận kết quả ảnh dưới dạng `b64_json`. Với request `url`, AI Sonar tải từng ảnh lên CDN rồi trả về `data[].url`. Nếu CDN storage không khả dụng hoặc upload thất bại, request sẽ thất bại và không chuyển thành response Base64. Với `b64_json`, Base64 gốc được trả về.
</ParamField>
