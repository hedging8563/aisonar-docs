...
Ghi chú tương thích: nếu yêu cầu `gpt-image-2` gửi `input_fidelity`, AI Sonar sẽ xóa trường này vì GPT Image 2 tự động xử lý đầu vào hình ảnh với độ trung thực cao.
</Note>
