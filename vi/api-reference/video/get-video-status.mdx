...
Nếu tác vụ không còn tồn tại hoặc không thể giải quyết thông qua hợp đồng async-task công khai, AI Sonar trả về `async_task_not_found` với thông điệp `Task not found or no longer available.`
</Info>
