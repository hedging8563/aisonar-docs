...
<ParamField body="model" type="string" default="veo3.1">
  ID model video. Mặc định API là `veo3.1`. Xem [hướng dẫn tạo video](/vi/guides/video-generation) và [Models API](/vi/api-reference/models/list-models) để biết năng lực model video công khai hiện tại.
</ParamField>
