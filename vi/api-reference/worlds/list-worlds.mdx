...
description: "Liệt kê các World Labs Marble world đã hoàn tất tạo qua AI Sonar"
---
...
Dùng `/v1/worlds/generations/{id}` cho các tác vụ đang chờ hoặc thất bại. Danh sách này chỉ trả về world đã hoàn tất mà AI Sonar đã lập chỉ mục sau khi tạo.
...
<ParamField body="status" type="string">
  Bộ lọc trạng thái tùy chọn. AI Sonar trả world hoàn tất cho `SUCCEEDED`; trạng thái khác thuộc endpoint tác vụ tạo.
</ParamField>
