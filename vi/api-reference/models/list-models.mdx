...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle` (object): giai đoạn vòng đời, ngày phát hành/ngừng hỗ trợ, mô hình thay thế và nguồn huy hiệu latest
  - `aisonar.commercial` (object): chính sách tính phí người dùng, lý do miễn phí và thời điểm miễn phí đến tùy chọn
  - `aisonar.badges` (array): huy hiệu hiển thị suy ra từ metadata lifecycle và commercial
</ResponseField>
