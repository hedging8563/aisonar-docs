...
| `logicalModel` | string | tối đa `100` ký tự | Tên model được yêu cầu |
...
- `logicalModel` là model công khai mà người gọi yêu cầu.
...
- `accessChannel=platform` nghĩa là request được tính phí qua kênh platform của AI Sonar.
