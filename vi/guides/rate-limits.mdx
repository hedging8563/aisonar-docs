...
AI Sonar triển khai giới hạn tốc độ để đảm bảo việc sử dụng công bằng và sự ổn định của nền tảng. Giới hạn sẽ khác nhau tùy theo cấp tài khoản.
...
<Note>
  Giới hạn tốc độ có thể thay đổi. Liên hệ support@aisonar.dev để yêu cầu giới hạn tùy chỉnh.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Liên hệ với chúng tôi để có giới hạn cao hơn">
    Nếu bạn cần giới hạn cao hơn, hãy liên hệ support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Đăng nhập vào [Dashboard](https://console.aisonar.dev) của bạn
2. Đi tới **Settings → Account**
3. Liên hệ bộ phận hỗ trợ kèm theo trường hợp sử dụng của bạn

Hoặc gửi email tới support@aisonar.dev với:
