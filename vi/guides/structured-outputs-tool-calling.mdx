...
Đầu ra cấu trúc và gọi công cụ là các hợp đồng cụ thể cho từng tuyến. AI Sonar chuyển tiếp một số định dạng API công khai, vì vậy mẫu sản xuất an toàn nhất là giữ hình dạng công cụ gốc của từng nhà cung cấp trên tuyến mà nó sở hữu và xác thực đầu ra mô hình trong ứng dụng của bạn.
...
Không gửi các công cụ tích hợp sẵn của nhà cung cấp qua một tuyến khác và mong đợi AI Sonar tự động dịch chúng.
...
AI Sonar không thực thi các chức năng của bạn. Ứng dụng của bạn sở hữu vòng lặp:
