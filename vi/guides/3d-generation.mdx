...
Tạo 3D là bất đồng bộ. `POST /v1/3d/generations` tạo một tác vụ AI Sonar; các phản hồi trạng thái hoàn thành trả về các tài sản mô hình có thể tải xuống như `model_url` và, khi có, các URL cụ thể theo định dạng.
