...
description: "Tạo các công việc truyền thông không đồng bộ, kiểm tra trạng thái công việc AI Sonar công khai, và đối chiếu kết quả cuối cùng mà không cần ID cụ thể của nhà cung cấp."
---

Nhiều điểm cuối truyền thông là không đồng bộ. Một yêu cầu tạo bắt đầu công việc và trả về một danh tính công việc AI Sonar công khai; ứng dụng của bạn sẽ kiểm tra cho đến khi công việc đó đạt trạng thái cuối cùng. Không xây dựng quy trình làm việc của khách hàng xung quanh các URL công việc upstream, ID định tuyến, hoặc hành vi callback của nhà cung cấp.
...
|-------|---------|------------|
| `id` | ID công việc AI Sonar công khai | Lưu trữ nó cùng với bản ghi công việc của bạn |
...
| Chủ Đề | Tài Liệu |
|--------|----------|
| Lấy Trạng Thái Công Việc | [Get Task Status](/vi/api-reference/tasks/get-task-status) |
| Hủy Công Việc | [Cancel Task](/vi/api-reference/tasks/cancel-task) |
| Tạo Hình Ảnh | [Image Generation](/vi/guides/image-generation) |
| Tạo Video | [Video Generation](/vi/guides/video-generation) |
| Tạo Nhạc | [Music Generation](/vi/guides/music-generation) |
| Tạo 3D | [3D Generation](/vi/guides/3d-generation) |
| Thanh Toán & Giá Cả | [Billing & Pricing](/vi/guides/billing) |
