---
title: "SDK & Thư viện"
description: "Các SDK và thư viện được khuyến nghị cho tích hợp AI Sonar"
---

## Tổng quan

AI Sonar dễ tích hợp nhất khi khớp SDK với hành vi bạn cần:
...
| Máy khách tương thích với OpenAI hiện có | OpenAI SDK trên AI Sonar `/v1` |
...
<AccordionGroup>
  ...
  <Accordion title="Dùng `/v1` tương thích OpenAI để di chuyển">
    Các SDK tương thích OpenAI là lựa chọn tốt nhất cho các client kiểu OpenAI hiện có, chat di động và embeddings. Hãy xem chúng như một tuyến tương thích, không phải là bề mặt API duy nhất của AI Sonar.
  </Accordion>

  <Accordion title="Giữ Base URL rõ ràng">
    Hãy truyền trực tiếp các URL gốc của AI Sonar trong cấu hình client của bạn thay vì dựa vào các bí danh biến môi trường cũ.
  </Accordion>
</AccordionGroup>
