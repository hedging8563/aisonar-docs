...
Cache prompt ở cấp nhà cung cấp được tự động hóa qua AI Sonar. Các system prompt dài — mà coding agent luôn bao gồm — được cache ở cấp nhà cung cấp:
...
| AI Sonar (định tuyến thông minh) | ~$10–18 | ~$1.600–2.900 |
| AI Sonar + cache prompt | ~$4–8 | ~$640–1.280 |
...
Mỗi công cụ chỉ cần vài dòng để kết nối qua AI Sonar:
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Cài đặt → Mô hình → Khóa API OpenAI: `sk-your-key`, URL cơ sở: `https://api.aisonar.dev/v1`
