...
description: "Cài skill tích hợp AI Sonar API đang được duy trì và hướng dẫn coding agent khám phá model, đọc chi tiết model và phục hồi từ lỗi API."
---
...
Lệnh này cài skill dùng chung `tokenlab-api-integration` từ repository AI Sonar skills.
...
| Hợp đồng non-chat không khớp | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_shape_mode`, `recommended_request` | Dựng lại yêu cầu từ chi tiết model và return a clear error với trường làm đổi ý định |
...
<Info>
Có câu hỏi? Dùng [GitHub Issues](https://github.com/hedging8563/tokenlab-skills/issues) hoặc liên hệ [](mailto:).
</Info>
