...
<ParamField body="model" type="string" required>
  要使用的模型 ID。可用選項請參閱 [Models](https://aisonar.dev/models)。
</ParamField>
