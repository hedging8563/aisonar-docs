...
description: "安裝維護中的 AI Sonar API 整合技能，讓 coding agent 能探索模型、讀取対応状況並從 API 錯誤中恢復。"
---
...
這會從 AI Sonar skills repository 安裝共用的 `tokenlab-api-integration` skill。
...
| 非聊天請求不相容 | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_shape_mode`, `recommended_request` | 按対応状況重建請求；會改變意圖的欄位必須 return a clear error |
...
<Info>
有問題？請使用 [GitHub Issues](https://github.com/hedging8563/tokenlab-skills/issues) 或聯絡 [](mailto:)。
</Info>
