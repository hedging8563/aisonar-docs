...
良好的 AI Sonar 可觀察性始於公共識別碼。您的日誌應該幫助您回答「用戶請求了什麼，AI Sonar 創建了什麼公共任務，以及如何計費？」而不暴露供應商路由內部或敏感的用戶數據。
...
除非 AI Sonar 支援明確要求提供已隱去的範本，否則請勿包括 API 鍵、管理令牌、私有媒體、完整提示、供應商 URL、通道 ID 或內部路由識別碼。
