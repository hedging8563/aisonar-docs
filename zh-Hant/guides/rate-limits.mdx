...
AI Sonar 實施速率限制，以確保公平使用與平台穩定性。限制會依帳戶層級而有所不同。
...
<Note>
  速率限制可能會有所變更。如需自訂限制，請聯絡 support@aisonar.dev。
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="聯絡我們以取得更高限制">
    如果你需要更高的限制，請聯絡 support@aisonar.dev。
  </Accordion>
</AccordionGroup>
...
1. 登入你的 [Dashboard](https://console.aisonar.dev)
2. 前往 **Settings → Account**
3. 聯絡支援團隊並提供你的使用案例

或寄送電子郵件至 support@aisonar.dev，並附上：
- 你的帳戶電子郵件
- 預期的請求量
- 使用案例說明