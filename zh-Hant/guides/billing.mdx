...
即時價格會隨供應商、路由和模型契約變化。請以 Dashboard、模型頁、`GET /v1/models/:model/pricing` 和 [Pricing API](/api-reference/pricing/get-pricing) 為準。
...
圖像、影片、音樂、3D、音訊和 world 生成模型可能按請求、圖片、秒/分鐘、任務或供應商特定用量計費。生產使用前請檢查所選模型契約。
...
如果任務已經進入終態，但 dashboard 中沒有看到對應結算或退款，請聯繫  尋求協助。
