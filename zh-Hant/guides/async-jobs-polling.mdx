---
title: "非同步任務與輪詢"
description: "創建非同步媒體任務，輪詢公共 AI Sonar 任務狀態，並在不使用供應商特定 ID 的情況下對賬最終結果。"
---

許多媒體端點是非同步的。創建請求開始工作並返回公共 AI Sonar 任務身份；您的應用程式將輪詢直到該任務達到終端狀態。請勿圍繞上游任務 URL、路由 ID 或供應商回調行為構建客戶工作流程。
...
| 欄位 | 意義 | 操作 |
|-------|---------|------------|
| `id` | 公共 AI Sonar 任務 ID | 與您自己的任務記錄一起存儲 |
