...
`model` 應使用 AI Sonar 顯示的模型 ID，再用 `operation` 和對應媒體輸入選擇操作能力。示例包括 `wan-2.7`、`happyhorse-1.0`、`viduq3`、`viduq3-mix`、`pixverse-v6`、`kling-3.0-video`、`veo3.1`、`seedance-2.0`；不要把供應商的操作名稱當成 AI Sonar 模型名。
