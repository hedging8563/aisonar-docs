...
Toutes les erreurs renvoient un format JSON cohérent avec des [Agent-First hints](/guides/agent-first-api) facultatifs :
...
Les routes publiques ne distinguent pas dans le corps de la réponse si un modèle est simplement mal orthographié, masqué, différé ou non public. Si un modèle n'est pas actuellement disponible via le détails du modèle, AI Sonar renvoie `model_not_found`.
