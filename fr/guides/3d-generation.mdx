...
La génération 3D est asynchrone. `POST /v1/3d/generations` crée une tâche AI Sonar ; les réponses de statut complété retournent des actifs de modèle téléchargeables tels que `model_url` et, lorsque disponible, des URL spécifiques au format.
