...
Utilisez les IDs de modèle affichés par AI Sonar dans `model`, puis choisissez les variantes avec `operation` et les entrees media correspondantes. Exemples : `wan-2.7`, `happyhorse-1.0`, `viduq3`, `viduq3-mix`, `pixverse-v6`, `kling-3.0-video`, `veo3.1` et `seedance-2.0`; n utilisez pas les noms d opération du fournisseur comme noms de modèles AI Sonar.
