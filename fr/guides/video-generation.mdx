...
- Pour `seedance-2.0` et `seedance-2.0-fast`, la référence à la vidéo peut accepter plusieurs images de référence ainsi que des entrées vidéo/audio de référence selon le contrat public actuel.
