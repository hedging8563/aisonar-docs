...
Les prix en direct peuvent changer selon les fournisseurs, routes et contrats de modèle. Le Dashboard, la page Modèles, `GET /v1/models/:model/pricing` et la [Pricing API](/api-reference/pricing/get-pricing) font foi.
...
Si le dashboard ne reflète pas le règlement ou le remboursement après l'apparition de l'état terminal, contactez .
...
Contactez  pour toute demande concernant la facturation.
