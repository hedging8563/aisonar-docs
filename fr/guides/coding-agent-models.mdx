...
## Sélection du fournisseur dans AI Sonar
...
Lorsque le modèle sélectionné prend en charge un format d'API natif, AI Sonar peut utiliser ce format pour une meilleure compatibilité :
