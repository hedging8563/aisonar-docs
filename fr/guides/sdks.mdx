...
description: "SDKs et bibliothèques recommandés pour les intégrations AI Sonar"
---
...
| Client compatible OpenAI existant | OpenAI SDK sur AI Sonar /v1 |
...
<AccordionGroup>
  ...
  <Accordion title="Utiliser /v1 compatible OpenAI pour les migrations">
    Les SDKs compatibles OpenAI conviennent aux clients existants de style OpenAI, au chat portable et aux embeddings. C’est une route de compatibilité, pas la seule surface API de AI Sonar.
  </Accordion>

  <Accordion title="Garder les base URLs explicites">
    Passez les base URLs AI Sonar directement dans la configuration du client au lieu de dépendre d’anciens alias d’environnement.
  </Accordion>
</AccordionGroup>
