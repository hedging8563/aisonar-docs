...
description: "Créez des travaux médias asynchrones, interrogez l'état des tâches publiques de AI Sonar et réconciliez les résultats finaux sans identifiants spécifiques au fournisseur."
---

De nombreux points de terminaison médias sont asynchrones. Une requête de création démarre le travail et renvoie une identité de tâche publique AI Sonar ; votre application interroge jusqu'à ce que cette tâche atteigne un état terminal. Ne construisez pas les flux de travail des clients autour des URL de tâches en amont, des ID de routage ou du comportement de rappel du fournisseur.
...
|-------|---------------|-----------|
| `id` | ID de tâche publique AI Sonar | Stockez-le avec votre propre enregistrement de travail |
