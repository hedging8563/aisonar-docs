...
<Note>
  Les limites de débit sont susceptibles d’être modifiées. Contactez  pour des limites personnalisées.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Contactez-nous pour des limites plus élevées">
    Si vous avez besoin de limites plus élevées, contactez .
  </Accordion>
</AccordionGroup>
