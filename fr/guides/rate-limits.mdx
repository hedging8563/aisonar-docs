...
AI Sonar met en place des limites de débit afin de garantir une utilisation équitable et la stabilité de la plateforme. Les limites varient selon le niveau de compte.
...
<Note>
  Les limites de débit sont susceptibles d’être modifiées. Contactez support@aisonar.dev pour des limites personnalisées.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Contactez-nous pour des limites plus élevées">
    Si vous avez besoin de limites plus élevées, contactez support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Connectez-vous à votre [Dashboard](https://console.aisonar.dev)
2. Allez dans **Settings → Account**
3. Contactez le support avec votre cas d’usage

Ou envoyez un email à support@aisonar.dev avec :
