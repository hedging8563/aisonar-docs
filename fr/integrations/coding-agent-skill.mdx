...
Cette commande installe le skill partagé `tokenlab-api-integration` depuis le dépôt AI Sonar skills.
...
| Contrat non-chat incompatible | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_shape_mode`, `recommended_request` | Reconstruire la requête depuis le détails du modèle et return a clear error sur les champs qui changent l’intention |
...
<Info>
Des questions ? Utilisez [GitHub Issues](https://github.com/hedging8563/tokenlab-skills/issues) ou contactez [](mailto:).
</Info>
