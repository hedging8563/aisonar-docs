...
| Rapide/économique | `gpt-5-mini`, `gemini-3.5-flash` |
...
<AccordionGroup>
  ...
  <Accordion title="Utiliser des modèles moins coûteux pour l’itération">
    Utilisez `gpt-5-mini` ou `gemini-3.5-flash` pendant l’itération, puis ne basculez les flux de travail plus lourds vers des modèles plus puissants que lorsque cela est nécessaire.
  </Accordion>
