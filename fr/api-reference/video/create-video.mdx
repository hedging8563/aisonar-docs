...
<ParamField body="model" type="string" default="veo3.1">
  ID du modèle vidéo. La valeur par défaut de l’API est `veo3.1`. Consultez le [guide de génération vidéo](/fr/guides/video-generation) et la [Models API](/fr/api-reference/models/list-models) pour les capacités vidéo publiques actuelles.
</ParamField>
