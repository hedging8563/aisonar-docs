...
Ces endpoints de gestion couvrent les médias appartenant à AI Sonar et les Worlds générés terminés. AI Sonar n’expose toujours pas la génération `marble-1.0-draft` ni les outils pano/depth autonomes.
