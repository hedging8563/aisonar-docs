...
| `logicalModel` | string | longueur maximale `100` | Nom du modèle demandé |
...
<ResponseField name="request_id" type="string">Identifiant public de requête pour support et rapprochement.</ResponseField>
