...
<ParamField body="top_n" type="integer">
  Nombre de meilleurs résultats à retourner. Par défaut, tous les documents. Doit être au moins `1` et ne pas dépasser `documents.length`. AI Sonar n'applique actuellement aucun plafond public plus bas propre à un fournisseur ; si cette limite change, cette page sera mise à jour avant son application.
</ParamField>
