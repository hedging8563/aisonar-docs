...
Pour les requêtes en streaming, omettez `generationConfig.candidateCount` ou laissez-le à `1`; les valeurs supérieures sont rejetées au lieu de supprimer silencieusement des candidats supplémentaires.
