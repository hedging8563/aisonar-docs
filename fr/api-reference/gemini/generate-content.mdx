...
<ParamField path="model" type="string" required>
  ...
  AI Sonar utilise le chemin Gemini natif lorsqu’il est disponible et bascule vers un chemin public compatible lorsque le traitement natif n’est pas disponible pour cette requête multimodale.
...
<ParamField body="contents" type="array" required>
  ...
  Pour les parties média, AI Sonar accepte actuellement les types MIME image, audio et vidéo, puis les transmet via le détails du modèle compatible Gemini.
