...
description: 'Référence complète pour l''API AI Sonar'
---
...
Récupérez votre clé API depuis le [Dashboard](https://console.aisonar.dev).
...
<Info>
Utilisez `/v1/realtime` pour les requêtes d’upgrade WebSocket. Un simple `GET /v1/realtime` renvoie les métadonnées de l’endpoint pour les clients qui ne peuvent pas inspecter directement les routes WebSocket.
</Info>
