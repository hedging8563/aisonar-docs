...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle` (object) : étape du cycle de vie, dates de sortie/dépréciation, modèle de remplacement et source du badge latest
  - `aisonar.commercial` (object) : politique de facturation utilisateur, raison de gratuité et échéance facultative
  - `aisonar.badges` (array) : badges dérivés du cycle de vie et des métadonnées commerciales
</ResponseField>
