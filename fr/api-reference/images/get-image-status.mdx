...
Si la tâche n'existe plus ou ne peut plus être résolue via le détails du modèle async-task, AI Sonar renvoie `async_task_not_found` avec le message `Task not found or no longer available.`
</Info>
