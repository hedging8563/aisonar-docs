...
## Selección de proveedor en AI Sonar
...
Cuando el modelo seleccionado admite un formato de API nativo, AI Sonar puede usar ese formato para una mejor compatibilidad:
