...
La generación 3D es asincrónica. `POST /v1/3d/generations` crea una tarea de AI Sonar; las respuestas de estado completadas devuelven activos de modelo descargables como `model_url` y, cuando están disponibles, URLs específicas de formato.
