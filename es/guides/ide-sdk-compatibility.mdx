...
| **Gemini CLI** | Mejor esfuerzo / experimental | Gemini | El flujo personalizado de URL base de AI Sonar no es una integración oficial de Gemini CLI |
...
<Note>
  Otros editores y herramientas de agentes compatibles con OpenAI suelen funcionar con el mismo patrón de base URL; revisa el soporte de proveedores personalizados de cada herramienta antes de usarla en producción.
</Note>
...
<AccordionGroup>
  <Accordion title="Usa passthrough para parámetros desconocidos">
    Los parámetros desconocidos solo se reenvían cuando la ruta pública y el modelo seleccionados los admiten.
  </Accordion>
