...
El contrato público de video de AI Sonar acepta estos valores de operación. El soporte depende del modelo y cambia cuando los proveedores agregan o retiran capacidades; revisa el contrato del modelo elegido antes de depender de una operación especializada.
...
Usa `aisonar.capabilities`, `aisonar.supported_operations`, `aisonar.public_contract_summary` y `aisonar.public_contract` como fuente de verdad. Los ejemplos siguientes son patrones de flujo, no un inventario exhaustivo.
