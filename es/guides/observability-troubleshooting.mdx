...
Una buena observabilidad de AI Sonar comienza con identificadores públicos. Tus registros deberían ayudarte a responder "¿qué solicitó el usuario, qué tarea pública creó AI Sonar y cómo se facturó?" sin exponer detalles sensibles del proveedor ni datos sensibles del usuario.
...
No incluyas claves de API, tokens de gestión, medios privados, prompts completos, URLs del proveedor, IDs de canales o identificadores privados de diagnóstico a menos que el soporte de AI Sonar solicite explícitamente una muestra redactada.
