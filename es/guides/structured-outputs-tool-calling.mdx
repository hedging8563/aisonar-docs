...
Las salidas estructuradas y las llamadas a herramientas son contratos específicos de ruta. AI Sonar reenvía varios formatos de API públicos, por lo que el patrón de producción más seguro es mantener cada forma nativa de herramienta del proveedor en la ruta que la posee y validar la salida del modelo en tu propia aplicación.
...
No envíes herramientas integradas nativas del proveedor a través de una ruta diferente y esperes que AI Sonar las traduzca silenciosamente.
...
AI Sonar no ejecuta tus funciones. Tu aplicación posee el bucle:
