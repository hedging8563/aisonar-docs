...
description: "Crea trabajos de medios asíncronos, consulta el estado de las tareas públicas de AI Sonar y reconcilia los resultados finales sin IDs específicos del proveedor."
---

Muchos endpoints de medios son asíncronos. Una solicitud de creación inicia el trabajo y devuelve una identidad de tarea pública de AI Sonar; tu aplicación consulta hasta que esa tarea alcanza un estado terminal. No construyas flujos de trabajo de clientes alrededor de URLs de tareas ascendentes, IDs de enrutamiento o comportamiento de callbacks del proveedor.
...
|-------|-------------|-----------|
| `id` | ID de tarea pública de AI Sonar | Almacénalo con tu propio registro de trabajo |
...
`DELETE /v1/tasks/{id}` es intencionalmente estrecho. Actualmente soporta tareas de video en cola de Volcengine Seedance como `seedance-1.5-pro`, `seedance-2.0` y `seedance-2.0-fast`.
...
| Generación de Video | [Video Generation](/es/guides/video-generation) |
| Generación de Música | [Music Generation](/es/guides/music-generation) |
| Generación 3D | [3D Generation](/es/guides/3d-generation) |
