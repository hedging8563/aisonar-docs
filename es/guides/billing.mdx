...
Los precios en vivo pueden cambiar según proveedores, rutas y contratos de modelo. Usa el Dashboard, la página de modelos, `GET /v1/models/:model/pricing` y la [Pricing API](/api-reference/pricing/get-pricing) como fuente de verdad.
...
Si el dashboard no refleja la liquidación o el reembolso después de que el estado terminal sea visible, contacta con .
...
Póngase en contacto con  para consultas de facturación.
