...
AI Sonar implementa límites de tasa para garantizar un uso justo y la estabilidad de la plataforma. Los límites varían según el nivel de cuenta.
...
<Note>
  Los límites de tasa están sujetos a cambios. Contacta a support@aisonar.dev para límites personalizados.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Contáctanos para límites más altos">
    Si necesitas límites más altos, contacta a support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Inicia sesión en tu [Dashboard](https://console.aisonar.dev)
2. Ve a **Settings → Account**
3. Contacta a soporte con tu caso de uso

O envía un email a support@aisonar.dev con:
