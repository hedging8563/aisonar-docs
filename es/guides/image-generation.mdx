...
Comience con el descubrimiento del modelo, luego inspeccione el contrato de AI Sonar del modelo seleccionado:
...
Para modelos que no son de chat, la respuesta de la lista puede incluir `aisonar.public_contract_summary`. Las páginas de detalles del modelo pueden exponer el `aisonar.public_contract` más completo. Use esos campos para confirmar:
