...
| `logicalModel` | string | longitud máxima `100` | Nombre del modelo solicitado |
...
<ResponseField name="request_id" type="string">Identificador público de solicitud para soporte y conciliación.</ResponseField>
