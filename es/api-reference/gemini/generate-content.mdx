...
<ParamField path="model" type="string" required>
  ...
  AI Sonar usa la ruta nativa de Gemini cuando está disponible y cambia a una ruta pública compatible cuando el manejo nativo no está disponible para esa solicitud multimodal.
...
<ParamField body="contents" type="array" required>
  ...
  Para las partes multimedia, AI Sonar acepta actualmente tipos MIME de imagen, audio y video, y los reenvía a través dlos detalhes do modelo compatible con Gemini.
...
Categorías multimedia compatibles actualmente en los detalhes do modelo de Gemini:
- imagen
- audio
- video
