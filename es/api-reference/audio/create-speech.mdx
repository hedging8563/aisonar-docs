...
<ParamField body="model" type="string" default="tts-1">
  Modelo TTS. Ejemplos compatibles con OpenAI: `tts-1` (estandar) y `tts-1-hd` (mayor calidad); la voz HD de MiniMax esta disponible como `speech-2.8-hd`. Consulta `GET /v1/models?recommended_for=tts` para la lista actual.
</ParamField>
