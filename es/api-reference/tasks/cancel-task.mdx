...
La cancelación se admite para tareas de video Seedance en cola cuando el proveedor seleccionado para esa tarea admite cancelación. Los modelos compatibles son `seedance-1.5-pro`, `seedance-2.0` y `seedance-2.0-fast`. Las tareas que ya están en `processing`/running no se pueden cancelar. Las tareas completadas, fallidas, expiradas o no compatibles siguen disponibles para consultar estado y conciliación de facturación.
