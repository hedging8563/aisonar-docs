...
<ParamField body="top_n" type="integer">
  Número de mejores resultados a devolver. Por defecto se devuelven todos los documentos. Debe ser al menos `1` y no puede superar `documents.length`. AI Sonar no aplica actualmente un límite público inferior específico de proveedor; si este límite cambia, esta página se actualizará antes de aplicarlo.
</ParamField>
