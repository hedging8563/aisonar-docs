...
Estos endpoints de gestión cubren medios propiedad de AI Sonar y Worlds generados completados. AI Sonar todavía no expone generación `marble-1.0-draft` ni herramientas pano/depth independientes.
