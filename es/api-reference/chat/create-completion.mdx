...
<ParamField body="model" type="string" required>
  ID del modelo a usar. Consulte [Models](https://aisonar.dev/models) para las opciones disponibles.
</ParamField>
...
<ParamField body="messages" type="array" required>
  ...
  Cuando `content` es un array, AI Sonar admite bloques multimodales estructurados para modelos compatibles:
  - text: `{ "type": "text", "text": "..." }`
  ...
  Para tráfico multimodal en producción, prefiera URLs públicas `https`. AI Sonar traducirá estos bloques de medios al formato de solicitud específico del proveedor requerido por el modelo físico enrutado.
</ParamField>
