...
Si la tarea ya no existe o ya no se puede resolver a través del detalles del modelo de tareas asíncronas, AI Sonar devuelve `async_task_not_found` con el mensaje `Task not found or no longer available.`
</Info>
