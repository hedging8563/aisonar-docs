...
Si la tarea ya no existe o ya no se puede resolver mediante los detalhes do modelo de async-task, AI Sonar devuelve `async_task_not_found` con el mensaje `Task not found or no longer available.`
</Info>
