...
description: "安装维护中的 AI Sonar API 集成技能，让 coding agent 能发现模型、读取模型说明并从 API 错误中恢复。"
---
...
这会从 AI Sonar skills 仓库安装共享的 `tokenlab-api-integration` skill。
...
| 非聊天请求不兼容 | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_shape_mode`, `recommended_request` | 按模型说明重建请求；会改变意图的字段必须 return a clear error |
...
<Info>
有问题？请使用 [GitHub Issues](https://github.com/hedging8563/tokenlab-skills/issues) 或联系 [](mailto:)。
</Info>
