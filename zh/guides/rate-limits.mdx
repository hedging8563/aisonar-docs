...
AI Sonar 实施速率限制以确保公平使用和平台稳定性。限制会因账户层级而异。
...
<Note>
  速率限制可能会发生变化。如需自定义限制，请联系 support@aisonar.dev。
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="联系我们以获取更高限制">
    如果你需要更高的限制，请联系 support@aisonar.dev。
  </Accordion>
</AccordionGroup>
...
1. 登录你的 [Dashboard](https://console.aisonar.dev)
2. 前往 **Settings → Account**
3. 联系支持团队并说明你的使用场景

或者发送邮件至 support@aisonar.dev，并提供：
- 你的账户邮箱
- 预期请求量
- 使用场景描述