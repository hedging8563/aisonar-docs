---
title: "可观察性与故障排除"
description: "记录支持所需的公共 AI Sonar 标识符、使用对账和异步媒体调试。"
---

良好的 AI Sonar 可观察性始于公共标识符。您的日志应帮助您回答“用户请求了什么，AI Sonar 创建了什么公共任务，以及如何计费？”而不暴露供应商路由内部或敏感用户数据。
...
| 您自己的作业/用户 ID | 您的应用程序 | 将 AI Sonar 活动与用户工作流关联 |
...
除非 AI Sonar 支持明确要求提供已编辑的示例，否则请勿包含 API 密钥、管理令牌、私有媒体、完整提示、供应商 URL、通道 ID 或内部路由标识符。
