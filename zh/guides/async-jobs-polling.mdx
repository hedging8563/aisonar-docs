---
title: "异步作业与轮询"
description: "创建异步媒体作业，轮询公共 AI Sonar 任务状态，并在没有提供商特定 ID 的情况下对最终结果进行对账。"
---

许多媒体端点是异步的。创建请求开始工作并返回公共 AI Sonar 任务标识；您的应用程序轮询直到该任务达到终止状态。请勿围绕上游任务 URL、路由 ID 或提供商回调行为构建客户工作流。
...
| 字段 | 含义 | 操作 |
|-------|---------|------------|
| `id` | 公共 AI Sonar 任务 ID | 将其与您自己的作业记录一起存储 |
