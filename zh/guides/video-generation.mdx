...
`model` 应使用产品级逻辑模型 ID，再用 `operation` 和对应媒体输入选择操作能力。示例包括 `wan-2.7`、`happyhorse-1.0`、`viduq3`、`viduq3-mix`、`pixverse-v6`、`kling-3.0-video`、`veo3.1`、`seedance-2.0`；不要把上游操作能力编码暴露成公开模型名。
