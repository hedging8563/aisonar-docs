---
title: "クイックスタート"
description: "2分でAI Sonar APIを始める"
---
...
<Steps>
  <Step title="アカウントを作成">
    サインアップは [aisonar.dev](https://aisonar.dev) で、メール、Gmail、または GitHub アカウントを使用して行ってください。
  </Step>
...
AI Sonar は300件以上のモデルをサポートしています。`model` フィールドだけを変更してください:
