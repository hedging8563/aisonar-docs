...
<ParamField body="top_n" type="integer">
  Number of top results to return. Defaults to all documents. Must be at least `1` and no greater than `documents.length`. If a provider publishes a stricter public limit later, AI Sonar will document and enforce it here.
</ParamField>
