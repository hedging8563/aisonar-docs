...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle`（object）：ライフサイクル段階、リリース/非推奨日、代替モデル、latest バッジの由来
  - `aisonar.commercial`（object）：ユーザー課金ポリシー、無料理由、任意の無料終了時刻
  - `aisonar.badges`（array）：ライフサイクルと商用メタデータから派生した表示バッジ
</ResponseField>
