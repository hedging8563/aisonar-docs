...
AI Sonar menerapkan batas rate untuk memastikan penggunaan yang adil dan stabilitas platform. Batas bervariasi berdasarkan tier akun.
...
<Note>
  Batas rate dapat berubah. Hubungi support@aisonar.dev untuk batas kustom.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Hubungi kami untuk batas yang lebih tinggi">
    Jika Anda memerlukan batas yang lebih tinggi, hubungi support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Masuk ke [Dashboard](https://console.aisonar.dev) Anda
2. Buka **Settings → Account**
3. Hubungi support dengan use case Anda

Atau kirim email ke support@aisonar.dev dengan:
- Email akun Anda
