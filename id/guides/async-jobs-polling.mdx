...
description: "Buat pekerjaan media asinkron, polling status tugas AI Sonar publik, dan rekonsiliasi hasil akhir tanpa ID spesifik penyedia."
---

Banyak endpoint media bersifat asinkron. Permintaan pembuatan memulai pekerjaan dan mengembalikan identitas tugas AI Sonar publik; aplikasi Anda melakukan polling hingga tugas tersebut mencapai status terminal. Jangan membangun alur kerja pelanggan di sekitar URL tugas upstream, ID routing, atau perilaku callback penyedia.
...
|-------|------|-------------------------|
| `id` | ID tugas AI Sonar publik | Simpan bersama catatan pekerjaan Anda sendiri |
