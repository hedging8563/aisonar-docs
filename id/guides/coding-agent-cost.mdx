...
Prompt caching di level provider berjalan otomatis melalui AI Sonar. System prompt panjang — yang selalu disertakan coding agents — di-cache di level provider:
...
| AI Sonar + kedua cache | ~$2–5 | ~$320–800 |
...
Setiap tool hanya membutuhkan beberapa baris untuk terhubung melalui AI Sonar:
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Pengaturan → Model → Kunci API OpenAI: `sk-your-key`, Base URL: `https://api.aisonar.dev/v1`
