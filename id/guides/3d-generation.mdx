...
Generasi 3D bersifat asinkron. `POST /v1/3d/generations` membuat tugas AI Sonar; respons status yang selesai mengembalikan aset model yang dapat diunduh seperti `model_url` dan, ketika tersedia, URL spesifik format.
