...
## Pemilihan Provider AI Sonar

AI Sonar secara otomatis memilih provider yang tersedia untuk model yang diminta.
...
Jika provider tidak tersedia atau mengembalikan error, AI Sonar secara otomatis mencoba ulang dengan provider lain yang tersedia:
...
Ketika model yang dipilih mendukung format API native, AI Sonar dapat menggunakan format tersebut untuk kompatibilitas yang lebih baik:
