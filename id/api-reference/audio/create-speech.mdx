...
<ParamField body="model" type="string" default="tts-1">
  Model TTS. Contoh yang kompatibel dengan OpenAI mencakup `tts-1` (standar) dan `tts-1-hd` (kualitas lebih tinggi); suara HD MiniMax tersedia sebagai `speech-2.8-hd`. Kueri `GET /v1/models?recommended_for=tts` untuk daftar terbaru.
</ParamField>
