...
<ParamField body="tools" type="array">
  ...
  Untuk tool hosted `image_generation` yang memakai model tool gambar default atau secara eksplisit menyetel `model: "gpt-image-2"`, AI Sonar menghapus `input_fidelity` yang tidak didukung sebelum meneruskan request karena GPT Image 2 sudah memperlakukan input gambar sebagai high fidelity. Jangan kirim `background: "transparent"` untuk tool ini; AI Sonar tidak menghapusnya diam-diam karena itu mengubah semantik output.
</ParamField>
