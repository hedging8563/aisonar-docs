...
<ParamField path="model" type="string" required>
  ...
  AI Sonar menggunakan jalur Gemini native jika tersedia dan beralih ke jalur publik yang kompatibel jika penanganan native tidak tersedia untuk request multimodal tersebut.
...
<ParamField body="contents" type="array" required>
  ...
  Untuk bagian media, AI Sonar saat ini menerima MIME type gambar, audio, dan video lalu meneruskannya melalui detail model yang kompatibel dengan Gemini.
