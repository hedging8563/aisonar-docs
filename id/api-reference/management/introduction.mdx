...
| `logicalModel` | string | panjang maks `100` | Nama model yang diminta |
...
| `models` | string[] | default `[]` | Daftar izin model opsional |
...
- `logicalModel` merujuk ke model publik yang diminta caller.
