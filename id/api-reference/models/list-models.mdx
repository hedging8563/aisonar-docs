...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle` (object): tahap lifecycle, tanggal rilis/depresiasi, model pengganti, dan sumber badge latest
  - `aisonar.commercial` (object): kebijakan biaya pengguna, alasan gratis, dan waktu gratis hingga opsional
  - `aisonar.badges` (array): badge tampilan dari metadata lifecycle dan commercial
</ResponseField>
