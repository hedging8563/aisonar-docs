...
<ParamField body="top_n" type="integer">
  Jumlah hasil teratas yang akan dikembalikan. Default ke semua dokumen. Nilainya harus minimal `1` dan tidak boleh lebih besar dari `documents.length`. Saat ini AI Sonar tidak menerapkan batas publik yang lebih rendah khusus provider; jika batas ini berubah, halaman ini akan diperbarui sebelum diberlakukan.
</ParamField>
