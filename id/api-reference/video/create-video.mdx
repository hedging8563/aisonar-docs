...
<ParamField body="model" type="string" default="veo3.1">
  ID model video. Default API adalah `veo3.1`. Lihat [panduan generasi video](/id/guides/video-generation) dan [Models API](/id/api-reference/models/list-models) untuk kemampuan model video publik saat ini.
</ParamField>
