---
title: "Panduan Cepat"
description: "Mulai dengan AI Sonar API dalam 2 menit"
---
...
<Steps>
  <Step title="Buat akun">
    Daftar di [aisonar.dev](https://aisonar.dev) menggunakan email, Gmail, atau akun GitHub Anda.
  </Step>
...
AI Sonar mendukung ratusan model. Ubah hanya field `model`:
