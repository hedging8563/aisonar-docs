---
title: "Anthropic SDK"
description: "Gunakan AI Sonar dengan Anthropic SDK untuk kompatibilitas Messages API native Claude"
---

## Gambaran Umum

AI Sonar mendukung path native Anthropic **Messages API**, sehingga Anda dapat menggunakan Anthropic SDK resmi secara langsung untuk model Claude.

<Note>
Untuk Anthropic SDK, gunakan `https://api.aisonar.dev` sebagai base URL, tanpa menambahkan `/v1` sendiri.
</Note>

Di antara rute SDK yang didokumentasikan, ini adalah salah satu jalur AI Sonar yang paling didukung untuk fitur native Claude.
...
<AccordionGroup>
  ...
  <Accordion title="Model Tidak Ditemukan">
    ...
    - Periksa ketersediaan saat ini di katalog model AI Sonar
  </Accordion>
</AccordionGroup>