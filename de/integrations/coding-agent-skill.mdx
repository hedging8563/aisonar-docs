...
| Nicht-Chat-Vertragskonflikt | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_shape_mode`, `recommended_request` | Anfrage aus dem Modelldetails neu bauen und intent-verändernde Felder return a clear error behandeln |
