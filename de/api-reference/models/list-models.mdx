...
<ResponseField name="data" type="array">
  ...
  - `aisonar.lifecycle` (object): Lifecycle-Status, Release-/Deprecation-Daten, Ersatzmodell und Latest-Badge-Quelle
  - `aisonar.commercial` (object): Nutzer-Abrechnungsrichtlinie, Free-Grund und optionaler Free-until-Zeitpunkt
  - `aisonar.badges` (array): Anzeige-Badges aus Lifecycle- und Commercial-Metadaten
</ResponseField>
