...
<ParamField path="model" type="string" required>
  ...
  AI Sonar verwendet den nativen Gemini-Pfad, wenn er verfügbar ist, und wechselt zu einem kompatiblen öffentlichen Pfad, wenn natives Handling für diese multimodale Anfrage nicht verfügbar ist.
...
<ParamField body="contents" type="array" required>
  ...
  Für Medien-Parts akzeptiert AI Sonar derzeit Bild-, Audio- und Video-MIME-Typen und leitet sie über den Gemini-kompatiblen Supported Operations weiter.
