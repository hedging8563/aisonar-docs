...
<ParamField path="model" type="string" required>
  ...
  AI Sonar uses the native Gemini path when available and switches to a compatible public path when native handling is unavailable for that multimodal request.
