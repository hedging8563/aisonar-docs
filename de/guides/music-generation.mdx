...
Die aktuellen öffentlichen Beispiele verwenden `suno_music` für die Musikgenerierung. Für nur Textflüsse senden Sie `action: "LYRICS"` mit einem Modell, dessen öffentlicher Vertrag die Liedgenerierung dokumentiert. Behandeln Sie Modell-IDs als öffentliche AI Sonar-IDs, nicht als Garantie, dass anbieter-spezifische Felder öffentliche Vertragsfelder sind.
