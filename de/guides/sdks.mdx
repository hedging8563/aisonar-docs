...
description: "Empfohlene SDKs und Bibliotheken für AI Sonar-Integrationen"
---

## Überblick

AI Sonar lässt sich am einfachsten integrieren, wenn du das SDK nach dem benötigten Verhalten auswählst:
...
| Bestehender OpenAI-kompatibler Client | OpenAI SDK mit AI Sonar /v1 |
...
<AccordionGroup>
  ...
  <Accordion title="OpenAI-kompatibles /v1 für Migration nutzen">
    OpenAI-kompatible SDKs sind ideal für bestehende OpenAI-ähnliche Clients, portable Chats und Embeddings. Sie sind ein Kompatibilitätspfad, nicht die einzige AI Sonar API-Oberfläche.
  </Accordion>

  <Accordion title="Base URLs explizit halten">
    Übergib AI Sonar Base URLs direkt in der Client-Konfiguration, statt ältere Environment-Variable-Aliase zu verwenden.
  </Accordion>
</AccordionGroup>
