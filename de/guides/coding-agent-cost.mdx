...
Prompt Cache auf Provider-Ebene funktioniert automatisch über AI Sonar:
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Einstellungen → Modelle → OpenAI-API-Schlüssel: `sk-your-key`, Basis-URL: `https://api.aisonar.dev/v1`
