...
Öffentliche Routen unterscheiden im Antwortkörper nicht zwischen Tippfehlern, versteckten, zurückgestellten oder nicht-öffentlichen Modellzuständen. Wenn ein Modell derzeit nicht über den Modelldetails verfügbar ist, gibt AI Sonar `model_not_found` zurück.
