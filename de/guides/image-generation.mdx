...
description: "Wählen Sie den richtigen AI Sonar-Bildendpunkt, senden Sie modellbewusste Anfragen und behandeln Sie synchrone oder asynchrone Bildresultate sicher."
---

AI Sonar unterstützt Text-zu-Bild, Bild-zu-Bild und Bildbearbeitung über öffentliche Bildendpunkte. Bildmodelle teilen sich kein universelles Parameterset, daher sollten Produktionsclients zuerst den Endpunkt wählen, dann das Modell auswählen und anschließend nur die von diesem Modell unterstützten Felder senden.
...
Beginnen Sie mit der Modellerkennung und überprüfen Sie den AI Sonar-Vertrag des ausgewählten Modells:
...
Für Nicht-Chat-Modelle kann die Listenantwort `aisonar.public_contract_summary` enthalten. Modell-Detailseiten können den umfassenderen `aisonar.public_contract` offenlegen. Verwenden Sie diese Felder zur Bestätigung:
...
- Anfragen im Stil von `gpt-image-2` verwenden OpenAI-ähnliche Felder wie `size`, `quality` und Bearbeitungsfelder. Lassen Sie optionale Felder weg, wenn Sie möchten, dass das Modell oder AI Sonar automatische Standardwerte verwendet.
...
- Validieren Sie Benutzereingaben, bevor Sie AI Sonar aufrufen: Prompt-Länge, Bildanzahl, URL-Erreichbarkeit und Dateityp.
