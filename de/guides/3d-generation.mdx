...
Die 3D-Generierung ist asynchron. `POST /v1/3d/generations` erstellt eine AI Sonar-Aufgabe; abgeschlossene Statusantworten geben herunterladbare Modell-Assets wie `model_url` zurück und, wenn verfügbar, format-spezifische URLs.
