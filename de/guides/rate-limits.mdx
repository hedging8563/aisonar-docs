...
<Note>
  Rate Limits können sich ändern. Kontaktieren Sie  für benutzerdefinierte Limits.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Kontaktieren Sie uns für höhere Limits">
    Wenn Sie höhere Limits benötigen, kontaktieren Sie .
  </Accordion>
</AccordionGroup>
...
Oder senden Sie eine E-Mail an  mit:
