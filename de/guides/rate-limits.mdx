...
AI Sonar implementiert Rate Limits, um eine faire Nutzung und die Stabilität der Plattform sicherzustellen. Die Limits variieren je nach Account-Tier.
...
<Note>
  Rate Limits können sich ändern. Kontaktieren Sie support@aisonar.dev für benutzerdefinierte Limits.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Kontaktieren Sie uns für höhere Limits">
    Wenn Sie höhere Limits benötigen, kontaktieren Sie support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Melden Sie sich in Ihrem [Dashboard](https://console.aisonar.dev) an
2. Gehen Sie zu **Settings → Account**
3. Kontaktieren Sie den Support mit Ihrem Anwendungsfall

Oder senden Sie eine E-Mail an support@aisonar.dev mit:
