...
description: "Move OpenAI, Anthropic, Gemini, and media workloads to AI Sonar with small, production-safe changes."
---
...
| Management and billing | `https://api.aisonar.dev/v1` | `/management/...` | Use management tokens for server-side usage and billing reconciliation |
...
2. Read `aisonar.public_contract_summary` in list responses and the full `aisonar.public_contract` where available.
