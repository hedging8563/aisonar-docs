...
<Note>
  Rate limits are subject to change. Contact support@aisonar.dev for custom limits.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Contact us for higher limits">
    If you need higher limits, contact support@aisonar.dev.
  </Accordion>
</AccordionGroup>
...
1. Log in to your [Dashboard](https://console.aisonar.dev)
2. Go to **Settings → Account**
3. Contact support with your use case

Or email support@aisonar.dev with:
- Your account email
